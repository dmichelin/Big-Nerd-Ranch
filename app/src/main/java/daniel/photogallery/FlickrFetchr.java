...
public class FlickrFetchr {
    ...
    public static final String API_KEY = "d1338fb785e9e26fd78d02275d6610ed";
    ...
    /*
    Fetches recent photos from flickr
     */
    ...
    /**
     * Searches flickr using the query
     * @param query The query keyword to search with
     * @return galleryitems of the search
     * @throws IOException
     */
    ...
    private List<GalleryItem> downloadGalleryItems(String url) {
        ...
        try {
            ...
            Log.e(TAG, "Failed to parse items", jso);
    ...
    private void parseItems(List<GalleryItem> items, JSONObject jsonBody) throws IOException, JSONException{
        ...
        System.out.println("Size of array: "+photoJsonArray.length());
